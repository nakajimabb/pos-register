    ...
    <Navbar fixed className="bg-gray-100 flex justify-between h-12">
      <Flex align_items="center">
        ...
        >
          ...
          <Dropdown.Item title="社内発注" to="/internal_order_new" />
          <Dropdown.Item title="社内発注一覧" to="/internal_order_list" />
        </Dropdown>
        <Dropdown
          icon={
            <Button color="light" size="sm" className="flex">
        ...
        >
          ...
          {role === 'manager' && <Dropdown.Item title="在庫集計表" to="/daily_stock_list" />}
        </Dropdown>
        <Dropdown
          icon={
            <Button color="light" size="sm" className="flex">
